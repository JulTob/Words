...
package body Words_Command is
    ...
    --Lectura de loss comandos
    procedure Command_Input (selector: in out integer) is
    ...
    function Lounch_Interactive_Mode return selector_type is
    ...
    procedure Interactive_Mode (List: in out Word_Lists.Word_List_Type) is
    	...
    	while not stop loop
    		...
    		case selector is
    			when 1 =>
    				...
    				Add_Word (List, Split.Clean_Word(ASU.To_String(Word)));

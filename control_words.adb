...
procedure lounch_control_mode( List: in out Word_Lists.Word_List_Type; stop: in out boolean) is
		selector:integer:=0;
	begin
...
procedure Dispose_List (Word_List: in out Word_Lists.Word_List_Type) is
...
procedure Activate_Control_Mode (Word_List: in out Word_Lists.Word_List_Type) is	
